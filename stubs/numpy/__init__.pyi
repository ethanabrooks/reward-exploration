"""
Numpy's mypy stub. Only type declarations for ndarray, the scalar hierarchy and array creation methods are provided.
"""
...
TestClass = Union[_TestClass[_S], _S]
...
class _ArrayLike(Generic[_S]):
    ...
    def all(self,
            ...
            keepdims: bool = False
            ) -> Union['_ArrayLike[_U]', '_ArrayLike[bool]']:
        ...
    ...
    def argmax(self, axis: int = None, out: '_ArrayLike[_U]' = None
               ) -> Union['_ArrayLike[_U]', '_ArrayLike[int]']:
        ...

    def argmin(self, axis: int = None, out: '_ArrayLike[_U]' = None
               ) -> Union['_ArrayLike[_U]', '_ArrayLike[int]']:
        ...
    ...
    def choose(
            self,
            choices: Sequence['_ArrayLike[_V]'],
            out: '_ArrayLike[_U]' = None,
            mode: str = 'raise') -> Union['_ArrayLike[_U]', '_ArrayLike[_V]']:
        ...

    def clip(self, a_min: Any, a_max: Any, out: '_ArrayLike[_U]' = None
             ) -> Union['_ArrayLike[_S]', '_ArrayLike[_U]']:
        ...
    ...
    def diagonal(self, offset: int = 0, axis1: int = 0,
                 axis2: int = 1) -> '_ArrayLike[_S]':
        ...
    ...
    def max(self, axis: AxesType = None, out: '_ArrayLike[_U]' = None
            ) -> Union['_ArrayLike[_S]', '_ArrayLike[_U]']:
        ...
    ...
    def mean(self,
             ...
             dtype: Any = None,
             out: '_ArrayLike[_U]' = None,
             keepdims: bool = False) -> '_ArrayLike[floating]':
        ...

    def min(self, axis: AxesType = None, out: '_ArrayLike[_U]' = None
            ) -> Union['_ArrayLike[_S]', '_ArrayLike[_U]']:
        ...
    ...
    def ptp(self, axis: int = None, out: '_ArrayLike[_U]' = None
            ) -> Union['_ArrayLike[_S]', '_ArrayLike[_U]']:
        ...
    ...
    def round(self, decimals: int = 0, out: '_ArrayLike[_U]' = None
              ) -> Union['_ArrayLike[_S]', '_ArrayLike[_U]']:
        ...

    def searchsorted(self,
                     v: Union[_S, '_ArrayLike[_S]'],
                     side: str = 'left',
    ...
    def tofile(
            ...
            fid: object,
            sep:
            str = '',  # TODO fix fid definition (There's a bug in mypy io's namespace https://github.com/python/mypy/issues/1462)
            format: str = '%s') -> None:
        ...
    ...
    def trace(self,
              ...
              axis2: int = 1,
              dtype: DtypeType = None,
              out: _ArrayLike[_U] = None) -> '_ArrayLike[Any]':
        ...
    ...
    def view(self,
             dtype: Union[DtypeType, Type['ndarray']] = None,
    ...
    def __divmod__(self, value: object
                   ) -> Tuple['_ArrayLike[int]', '_ArrayLike[float]']:
        ...

    def __eq__(self, value: object) -> '_ArrayLike[bool]':
        ...  # type: ignore
    ...
    def __ne__(self, value: object) -> '_ArrayLike[bool]':
        ...  # type: ignore
    ...
    def __rdivmod__(self, value: object
                    ) -> Tuple['_ArrayLike[int]', '_ArrayLike[float]']:
        ...
...
def asanyarray(a: Any, dtype: DtypeType = None,
               order: str = None) -> ndarray[Any]:
    ...  # TODO figure out a way to restrict the return type


def asmatrix(data: Any, dtype: DtypeType = None) -> Any:
    ...  # TODO define matrix
...
def clip(a: _ArrayLike[_S], a_min: _ArrayLike[_S],
         a_max: _ArrayLike[_S]) -> _ArrayLike[_S]:
    ...
...
def frombuffer(
        ...
        count: int = -1,  # TODO figure out a way to restrict buffer
...
def loadtxt(fname: Any,
            dtype: DtypeType = float,
            comments: Union[str, Sequence[str]] = '#',
            delimiter: str = None,
            converters: Dict[int, Callable[[Any], float]] = None,
            skiprows: int = 0,
            usecols: Sequence[int] = None,
            unpack: bool = False,
            ndmin: int = 0) -> ndarray[float]:
    ...


def ones(shape: ShapeType, dtype: Optional[DtypeType] = ...,
         order: str = 'C') -> ndarray[Any]:
    ...
